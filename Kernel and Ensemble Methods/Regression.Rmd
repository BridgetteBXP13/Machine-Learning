...
#### Evaluating after Tune

```{r}
predLinSvmTune <- predict(tuneLin$best.model, newdata=full_stats_test)
corLinSvmTune <- cor(predLinSvmTune, full_stats_test$won)
mseLinSvmTune <- mean((predLinSvmTune - full_stats_test$won)^2)
```
